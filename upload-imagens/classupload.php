...
$mensagem = "<a href='".$uploadfile."'><font color='#FFF'>Upload realizado com sucesso! ClIQUE AQUI para vizualizar.</font><a>";
} // -> fim else
...
$tamanho = $file['size'];
$pasta = $caminho.$nome;
 $sql = "INSERT INTO leis_detalhe (id_lei, nome, caminho, tamanho, data) VALUES ('$id_lei','$nome','$pasta','$tamanho', now())";
