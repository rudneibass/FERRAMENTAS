...
--
-- Host: 127.0.0.1
-- Generation Time: 03-Dez-2018 às 11:33
...
(8, '2018-11-23 09:10:07', 'sexta-feira 23 de nov', 'MATHEUS ARAÃšJO', 'MATHEUS ARAÃšJO', '', 0, '', '', 0, 0, '', 'ANA LÃšCIA BATISTA GUEDES', 'JOSÃ‰ AIRTON ARAÃšJO', '05/10/1994', 'CEDRO', '', '', '', 0, '', '', '', '', '', '(88)9805-7743', '', '', '', 'servidores/img/30.jpg', '', 'servidor');
...
--
-- Indexes for table `legislaturas`
--
ALTER TABLE `legislaturas`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `legislaturas`
--
ALTER TABLE `legislaturas`
